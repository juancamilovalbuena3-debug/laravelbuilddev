<x-app-layout>
    ...
    <div id="modal-confirmar" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50">
        <div class="bg-white rounded-2xl shadow-xl p-8 max-w-sm w-full text-center">
            ...
            <h2 class="text-xl font-semibold text-gray-800 mb-6">¿Publicar vehículo?</h2>
            <div class="flex justify-center gap-4">
                <button onclick="confirmarPublicar()"
                        class="bg-blue-600 hover:bg-indigo-700 text-white font-semibold px-6 py-2 rounded-lg">
                    Sí, publicar
                </button>

        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="border rounded-lg shadow-md p-4 bg-white">
                ...
                <div class="mt-4 flex space-x-2">
                    ...
                    <form action="{{ route('motos.comprar', $moto['id']) }}" method="POST" class="flex-1">
                        @csrf
                        <button type="submit"
                                class="w-full bg-white hover:bg-gray-200 text-black font-semibold px-4 py-2 rounded border">
                            Comprar
                        </button>
                    </form>
                </div>
...
with open(r'C:\\Users\\adminsena\\Downloads\\motrixpython-main\\resources\\views\\vehiculos\\motos.blade.php', 'w') as f:
    f.write(content)
print('Blade guardado OK')